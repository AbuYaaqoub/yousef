...
export default function MazeedDashboard() {
    ...
    const startMazeedScrape = async (overrideQuery?: string, overrideLimit?: number, itemId?: string, overrideCategory?: string) => {
    ...
    useEffect(() => {
        if (isQueueRunning && !loading) {
            ...
            if (nextItem) {
                ...
                startMazeedScrape(nextItem.query, nextItem.limit, nextItem.id, nextItem.category);
            } else {
